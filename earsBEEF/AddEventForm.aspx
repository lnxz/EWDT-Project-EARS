        ...
        <tr>
            ...
            &nbsp;<asp:DropDownList ID="DdlMonth" runat="server" Height="22px" Width="76px" 
                    ...
                    <tr>
                        ...
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                            ...
                            <asp:RangeValidator ID="RangeValidator1" runat="server" 
                                ControlToValidate="tbxQuota" ErrorMessage="Invalid Range (1-999)" 
                                ForeColor="Red" MaximumValue="999" MinimumValue="1"></asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:DropDownList ID="DdlDay1" runat="server" Height="22px" Width="76px" 
                                onselectedindexchanged="DdlDay1_SelectedIndexChanged">
                    <asp:ListItem>Day</asp:ListItem>
                </asp:DropDownList>
                            <span class="style25">&nbsp;/ 
                           </span> 
